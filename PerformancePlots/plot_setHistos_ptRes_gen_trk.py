...
p_ptResFitSigma_gen_trk_eta, p_ptResFitSigma_gen_trk_eta_label, p_ptResFitSigma_gen_trk_eta_title, p_ptResFitSigma_gen_trk_eta_x, p_ptResFitSigma_gen_trk_eta_y = [], "ptResFitSigma_gen_trk_eta", "p_{T} res. for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV)", "#eta", "#sigma(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitMean_gen_trk_eta, p_ptResFitMean_gen_trk_eta_label, p_ptResFitMean_gen_trk_eta_title, p_ptResFitMean_gen_trk_eta_x, p_ptResFitMean_gen_trk_eta_y = [], "ptResFitMean_gen_trk_eta", "p_{T} res. mean for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV)", "#eta", "mean(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitSigma_gen_trk_phi, p_ptResFitSigma_gen_trk_phi_label, p_ptResFitSigma_gen_trk_phi_title, p_ptResFitSigma_gen_trk_phi_x, p_ptResFitSigma_gen_trk_phi_y = [], "ptResFitSigma_gen_trk_phi", "p_{T} res. for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, |#eta|<2.4)", "#phi", "#sigma(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitMean_gen_trk_phi, p_ptResFitMean_gen_trk_phi_label, p_ptResFitMean_gen_trk_phi_title, p_ptResFitMean_gen_trk_phi_x, p_ptResFitMean_gen_trk_phi_y = [], "ptResFitMean_gen_trk_phi", "p_{T} res. mean for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, |#eta|<2.4)", "#phi", "mean(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitSigma_gen_trkB_phi, p_ptResFitSigma_gen_trkB_phi_label, p_ptResFitSigma_gen_trkB_phi_title, p_ptResFitSigma_gen_trkB_phi_x, p_ptResFitSigma_gen_trkB_phi_y = [], "ptResFitSigma_gen_trkB_phi", "p_{T} res. for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, |#eta|<0.9)", "#phi", "#sigma(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitMean_gen_trkB_phi, p_ptResFitMean_gen_trkB_phi_label, p_ptResFitMean_gen_trkB_phi_title, p_ptResFitMean_gen_trkB_phi_x, p_ptResFitMean_gen_trkB_phi_y = [], "ptResFitMean_gen_trkB_phi", "p_{T} res. mean for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, |#eta|<0.9)", "#phi", "mean(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitSigma_gen_trkEOp_phi, p_ptResFitSigma_gen_trkEOp_phi_label, p_ptResFitSigma_gen_trkEOp_phi_title, p_ptResFitSigma_gen_trkEOp_phi_x, p_ptResFitSigma_gen_trkEOp_phi_y = [], "ptResFitSigma_gen_trkEOp_phi", "p_{T} res. for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, 0.9<#eta<2.4)", "#phi", "#sigma(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitMean_gen_trkEOp_phi, p_ptResFitMean_gen_trkEOp_phi_label, p_ptResFitMean_gen_trkEOp_phi_title, p_ptResFitMean_gen_trkEOp_phi_x, p_ptResFitMean_gen_trkEOp_phi_y = [], "ptResFitMean_gen_trkEOp_phi", "p_{T} res. mean for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, 0.9<#eta<2.4)", "#phi", "mean(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitSigma_gen_trkEOm_phi, p_ptResFitSigma_gen_trkEOm_phi_label, p_ptResFitSigma_gen_trkEOm_phi_title, p_ptResFitSigma_gen_trkEOm_phi_x, p_ptResFitSigma_gen_trkEOm_phi_y = [], "ptResFitSigma_gen_trkEOm_phi", "p_{T} res. for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, -2.4<#eta<-0.9)", "#phi", "#sigma(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
...
p_ptResFitMean_gen_trkEOm_phi, p_ptResFitMean_gen_trkEOm_phi_label, p_ptResFitMean_gen_trkEOm_phi_title, p_ptResFitMean_gen_trkEOm_phi_x, p_ptResFitMean_gen_trkEOm_phi_y = [], "ptResFitMean_gen_trkEOm_phi", "p_{T} res. mean for #mu_{TRK} (p_{T}>" + str(threshold_pT_GeV) + " GeV, -2.4<#eta<-0.9)", "#phi", "mean(q/p_{T GEN} - q/p_{T TRK}) [1/GeV]"
