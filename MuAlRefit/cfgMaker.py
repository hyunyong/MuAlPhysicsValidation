...
for i, dataSet in enumerate(dataSets):
  for d in dataSet:
    ...
    os.system("cat {tmpCRAB} | sed -e 's/REQUESTNAME/{REQUESTNAME}/; s/CFGNAME/{CFGNAME}/; s/DTDBINPUT/{DT}/; s/CSCDBINPUT/{CSC}/; s/GPRDBINPUT/{GPR}/; s/JSONINPUT/{JSONINPUT}/; s/USER/{USER}/; s/STORAGEDIR/{STORAGEDIR}/' > {outCRAB}".format(**inputs))
